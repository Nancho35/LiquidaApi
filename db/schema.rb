...
ActiveRecord::Schema.define(version: 2019_05_25_155403) do
  ...
  create_table "aq$_internet_agents", primary_key: "agent_name", id: :string, limit: 512, force: :cascade do |t|
...
#   Unknown type 'SYS.AQ$_SUBSCRIBERS' for column 'subscribers'
  ...
  create_table "liquidacions", force: :cascade do |t|
    ...
    t.float "salario"
    t.float "auxilio"
    t.integer "horas_ex_diur", precision: 38
    t.integer "horas_ex_noc", precision: 38
    t.integer "recargos_noc", precision: 38
    t.integer "domi_ordinarios", precision: 38
    t.integer "horas_ex_domi_diur", precision: 38
    t.integer "horas_ex_domi_noc", precision: 38
    t.float "otros"
    ...
    t.integer "calc_art64", precision: 38
    t.boolean "check65"
    t.date "fecha_ini_pactada"
    t.date "fecha_fin_pactada"
    t.integer "num_pro", precision: 38
  ...
  create_table "logmnr_uid$", primary_key: "logmnr_uid", force: :cascade do |t|
    t.decimal "logmnr_did"
...
#   Unknown type 'LONG' for column 'query_text'
  ...
  create_table "mview$_adv_parameters", primary_key: "parameter_name", id: :string, limit: 128, comment: "Summary advisor tuning parameters", force: :cascade do |t|
...
#   Unknown type 'LONG' for column 'sql_text'
  ...
  create_table "redo_db", id: false, force: :cascade do |t|
    ...
    t.decimal "spare11"
    t.decimal "spare12"
    t.index ["dbid", "thread#", "resetlogs_scn", "resetlogs_time"], name: "redo_db_idx", tablespace: "sysaux"
  end
  ...
  create_table "redo_log", id: false, force: :cascade do |t|
    ...
    t.index ["dbid", "thread#", "resetlogs_scn", "resetlogs_time"], name: "redo_log_idx", tablespace: "sysaux"
  end
  ...
  create_table "rolling$connections", id: false, force: :cascade do |t|
    ...
    t.datetime "connect_time", precision: 6
    t.datetime "send_time", precision: 6
    t.datetime "disconnect_time", precision: 6
  ...
  create_table "rolling$events", id: false, force: :cascade do |t|
    ...
    t.decimal "instid"
    t.decimal "revision"
    t.datetime "event_time", precision: 6
  ...
  create_table "rolling$plan", id: false, force: :cascade do |t|
    ...
    t.datetime "exec_time", precision: 6
  ...
  create_table "rolling$statistics", id: false, force: :cascade do |t|
    ...
    t.decimal "valuenum"
    t.datetime "valuets", precision: 6
  ...
  create_table "rolling$status", id: false, force: :cascade do |t|
    ...
    t.datetime "init_time", precision: 6
    t.datetime "build_time", precision: 6
    t.datetime "start_time", precision: 6
    t.datetime "switch_time", precision: 6
    t.datetime "finish_time", precision: 6
